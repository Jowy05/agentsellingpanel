...
$cl = [
  ['sonrisa','Clínica Dental Sonrisa','gerencia@clinicasonrisa.es','Salud','Plan Recepción 500',500,'Mar 2025','18','930905101','185','950',320],
  ['aurora','Seguros Aurora','soporte@segurosaurora.es','Seguros','Plan Empresa 1200',1200,'Dic 2024','18','930905102','186','951',1100],
];
$ins = $pdo->prepare("INSERT INTO clientes (slug,nombre,correo,sector,plan,minutos_contratados,alta,tenant,ddi,ivr_normal,ivr_corte,estado_desvio,creado,actualizado)
...
$periodo = date('Y-m');
foreach ($cl as $c) {
  $ins->execute([$c[0],$c[1],$c[2],$c[3],$c[4],$c[5],$c[6],$c[7],$c[8],$c[9],$c[10]]);
  $cons->execute([$pdo->lastInsertId(), $periodo, $c[11]]);
}
